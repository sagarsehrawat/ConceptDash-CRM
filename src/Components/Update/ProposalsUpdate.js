                                ...
                                <Table sx={{ minWidth: 650 }} aria-label="simple table">
                                    ...
                                    {value.length > 0 ? tableFilter.map((row) => {
                                      return (
                                        ...
                                        >
                                        <TableCell align="right"><Button onClick={(e) => {navigate("/updateProposal", {state: row})}} style={{'backgroundColor':'rgb(99, 138, 235)'}}>Edit</Button></TableCell>
                                        <TableCell align="right" component="th" scope="row">
                                        {row.Proposal_ID}
                                        </TableCell>
                                        <TableCell align="right">{row.Department}</TableCell>
                                        <TableCell align="right">{row.Project_Name}</TableCell>
                                        <TableCell align="right">{row.Question_Deadline?row.Question_Deadline.substring(0, 10):''}</TableCell>
                                        <TableCell align="right">{row.Closing_Deadline?row.Closing_Deadline.substring(0, 10):''}</TableCell>
                                        <TableCell align="right">{row.Result_Date?row.Result_Date.substring(0, 10):''}</TableCell>
                                        <TableCell align="right">{row.Status}</TableCell>
                                        <TableCell align="right">{row.Manager_Name}</TableCell>
                                        <TableCell align="right">{row.Team}</TableCell>
                                        <TableCell align="right">{row.Design_Price}</TableCell>
                                        <TableCell align="right">{row.Provisional_Items}</TableCell>
                                        <TableCell align="right">{row.Contract_Admin_Price}</TableCell>
                                        <TableCell align="right">{row.Sub_Consultant_Price}</TableCell>
                                        ...
                                        <TableCell align="right">{row.Bidder_Price}</TableCell>
                                        <TableCell align="right">{row.Bid_Status}</TableCell>
                                        <TableCell align="right">{row.Winning_Price}</TableCell>
