  ...
  return (
    <>
      ...
      >
        ...
        <td className={styles["table-cell"]}>{Utils.formatMoney(invoiceProject.project_value)}</td>
        <td className={styles["table-cell"]}>{Utils.formatMoney(invoiceProject.recieved_amount)}</td>
        <td className={styles["table-cell"]}>{Utils.formatMoney(invoiceProject.balance)}</td>
      </tr>
      {isVisible && (
        <tr>
                ...
                <tbody>
                  {
                    invoices.map((invoice) => (
                      ...
                      <td className={`${styles["table-cell"]} ${styles['border']}`}>
                        <TFViewChip label="Invoice" onClick={() => {setInvoiceId(invoice.invoice_id)}} />
                      </td>
                    </tr>
                    ))
                  }
