        ...
        >
          ...
          <div className="d-flex flex-row align-items-center gap-8">
            <input
              ...
              onChange={(e) => handleForm(e.target.name, "Calculation Sheet")}
            />
          ...
          <div className="d-flex flex-row align-items-center gap-8">
            <input
              ...
              onChange={(e) => handleForm(e.target.name, "Number of Chamber")}
            />
        ...
        >
          <div className="d-flex flex-row align-items-center gap-8">
            <input
              ...
              onChange={(e) => handleForm(e.target.name, "Number of Layers")}
            />
          ...
          <div className="d-flex flex-row align-items-center gap-8">
            <input
              ...
              onChange={(e) => handleForm(e.target.name, "Treatment Row")}
            />
