...
import {
  ...
  import AuthenticationContext from "../../../Context/AuthContext.js";
  import GreenAlert from "../../../Main/Loader/GreenAlert.js";
  import LoadingSpinner from "../../../Main/Loader/Loader.js";
  import RedAlert from "../../../Main/Loader/RedAlert.js";
  ...
  } from "../../../Main/Constants/Constants.js";
  import moment from "moment";
  import UpdateProjectForm from "../forms/UpdateProjectForm.ts";
          ...
          const call = async () => {
            await axios
              ...
              .then((res) => {
                ...
                let sum = 0;
                arr.map((e) => {
                  if (e.Status === "In Progress") p.ongoingProjects = e.Count;
                  if (e.Status === "Not Started") p.newProjects = e.Count;
                  if (e.Status === "Completed") p.completedProjects = e.Count;
                  sum += e.Count;
                });
                p.totalProjects = sum;
                dispatch(initData(p));
          ...
          <>
            ...
            >
              <div style={styles.topContainer}>
                ...
                <div className="">
                  <p style={styles.topContainerSubheading}>{newProjects}</p>
                  {percentage >= 0 ? (
                    <div
                    ...
                    >
                      ...
                      <p style={styles.percent}>{percentage}% increase</p>
                    </div>
                  ) : (
                    <div
                      style={{ marginLeft: "26px", display: "inline-block" }}
              ...
              <div style={styles.topContainer}>
                ...
                <p style={styles.topContainerSubheading}>{ongoingProjects}</p>
              </div>
              <div style={styles.topContainer}>
                <p style={styles.topContainerHeading}>Completed Projects</p>
                <p style={styles.topContainerSubheading}>{completedProjects}</p>
              </div>
              <div style={styles.topContainer}>
                <p style={styles.topContainerHeading}>Total Projects</p>
                <p style={styles.topContainerSubheading}>{totalProjects}</p>
              </div>
            </div>
                        ...
                        >
                          ...
                          >
                            <div
                              ...
                              style={{ gap: "12px" }}
                            >
                              {e.isRoster===true ? projectDetails.includes(e.Project_Id) ? (
                                <FontAwesomeIcon
                                  icon={faChevronDown}
                                  onClick={(eve) =>
