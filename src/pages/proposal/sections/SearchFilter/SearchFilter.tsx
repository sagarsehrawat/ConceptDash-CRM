...
const SearchFilter = ({ api, setApi, value, setValue, filter, setFilter, isCollapsed }: Props) => {
    ...
    const [prevFilter, setprevFilter] = useState<FilterType>({ dept: [], cat: [], city: [], manager: [], bookmark: false });
    ...
    const filterSize = () => {
      return filter.city.length + filter.cat.length + filter.dept.length + filter.manager.length + (filter.bookmark===true?1:0);
    }
    ...
    const bookmarkFilterButton = (
      <div
        ...
        onClick={()=>{handleFilter('bookmark',0)}}
      >
                ...
                <div className='d-flex align-items-center'>
                  <Button
                    ...
                    onClick={() => {
                      ...
                      setprevFilter({ dept: [], cat: [], city: [], manager: [],bookmark: false });
                      setApi(api + 1);
                      setShow(false);
                    }}>
                    Clear All
