...
import { HOST, GET_COMPANY_NAMES, ADD_CONTACT,GET_CITIES } from '../Constants/Constants';
...
function CustomerForm() {
  ...
  <Row className="mb-4">
      ...
      <Row className="mb-4">
      <Form.Group as={Col}>
        <Form.Select name="salutation" type="text" onChange={handleChange}>
      ...
      <Row className="mb-4">
        <Form.Group as={Col} controlId="formGridEmail">
          <Form.Control onChange={handleChange} name='emailPersonal' type="email" placeholder="Email Personal" />
        </Form.Group>
        <Form.Group as={Col} controlId="formGridEmail">
          <Form.Control onChange={handleChange} name='emailWork' type="email" placeholder="Email Work" />
        </Form.Group>
      </Row>
      <Form.Group className="mb-4" as={Col} >
          <Form.Control onChange={handleChange} name='jobtitle' type="text" placeholder="Job Title"/>
      </Form.Group>
      <Row className="mb-4">
        <Form.Group as={Col}>
          <Form.Control onChange={handleChange} name='business' type="tel" placeholder="Business Phone"/>
        </Form.Group>
        <Form.Group as={Col}>
      ...
      <Row className="mb-4">
        <Form.Group as={Col}>
          <Form.Control onChange={handleChange} name='webpage' type="url" placeholder="Web-Page"/>
        </Form.Group>
