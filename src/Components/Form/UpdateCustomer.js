...
function UpdateCustomer(props) {
  ...
  // const province = props.row.Province;
  // const countri = props.row.Country;
        ...
        <Row className="mb-4">
          <Form.Group as={Col} controlId="formGridCity">
            ...
            >
              ...
              <option value="Mill Woods Town Centre">
              ...
              <option value="Central Coast Regional District">
              ...
              <option value="Denman Island Trust Area">
              ...
              <option value="Fraser Valley Regional District">
              ...
              <option value="Metro Vancouver Regional District">
              ...
              <option value="North Oyster/Yellow Point">
              ...
              <option value="Peace River Regional District">
              ...
              <option value="Regional District of Alberni-Clayoquot">
                Regional District of Alberni-Clayoquot
              </option>
              <option value="Regional District of Central Okanagan">
              ...
              <option value="Florenceville-Bristol">
              ...
              <option value="Shediac Bridge-Shediac River">
              ...
              <option value="Channel-Port aux Basques">
                Channel-Port aux Basques
              </option>
              <option value="Clarenville-Shoal Harbour">
              ...
              <option value="Happy Valley-Goose Bay">
              ...
              <option value="Stephenville Crossing">
              ...
              <option value="Fossambault-sur-le-Lac">
              ...
              <option value="L'Ascension-de-Notre-Seigneur">
              ...
              <option value="La Haute-Saint-Charles">
              ...
              <option value="Metabetchouan-Lac-a-la-Croix">
              ...
              <option value="Notre-Dame-de-l'Île-Perrot">
                Notre-Dame-de-l'Île-Perrot
              </option>
              <option value="Notre-Dame-des-Prairies">
                Notre-Dame-des-Prairies
              </option>
              <option value="Notre-Dame-du-Lac">Notre-Dame-du-Lac</option>
              <option value="Notre-Dame-du-Mont-Carmel">
              ...
              <option value="Saint-Adolphe-d'Howard">
              ...
              <option value="Saint-Antoine-de-Tilly">
              ...
              <option value="Saint-Bruno-de-Guigues">
                Saint-Bruno-de-Guigues
              </option>
              <option value="Saint-Bruno-de-Montarville">
              ...
              <option value="Saint-Germain-de-Grantham">
              ...
              <option value="Saint-Joseph-de-Beauce">
                Saint-Joseph-de-Beauce
              </option>
              <option value="Saint-Joseph-de-Coleraine">
                Saint-Joseph-de-Coleraine
              </option>
              <option value="Saint-Joseph-du-Lac">Saint-Joseph-du-Lac</option>
              <option value="Saint-Lambert-de-Lauzon">
                Saint-Lambert-de-Lauzon
              </option>
              <option value="Saint-Laurent">Saint-Laurent</option>
              <option value="Saint-Lazare">Saint-Lazare</option>
              <option value="Saint-Léonard">Saint-Léonard</option>
              <option value="Saint-Léonard-d'Aston">
              ...
              <option value="Saint-Philippe-de-La Prairie">
                Saint-Philippe-de-La Prairie
              </option>
              <option value="Saint-Pie">Saint-Pie</option>
              <option value="Saint-Pierre-les-Becquets">
              ...
              <option value="Saint-Rémi-de-Tingwick">
                Saint-Rémi-de-Tingwick
              </option>
              <option value="Saint-Sauveur">Saint-Sauveur</option>
              <option value="Saint-Sauveur-des-Monts">
              ...
              <option value="Sainte Catherine de la Jacques Cartier">
              ...
              <option value="Sainte-Anne-de-Bellevue">
                Sainte-Anne-de-Bellevue
              </option>
              <option value="Sainte-Anne-des-Monts">
