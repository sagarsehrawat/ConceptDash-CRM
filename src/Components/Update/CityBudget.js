    ...
    return (
        <>
            <div className='row justify-content-evenly' style={{ height: "100%", overflow: "hidden" }}>
                <div className='' style={{ maxWidth: "12vw", height: "42vh", overflowY: "auto", marginTop: "25vh", marginBottom: "25vh", border: "1px solid black", padding: "1rem" }}>
                    <Form.Control
                        placeholder="Search"
                    ...
                    {filterCities.map(e => {
                        return (<>
                            <p style={{ cursor: "pointer" }} onClick={(e) => { setCity({ City_ID: e.target.getAttribute('cityId'), City: e.target.innerText }); setCall(apiCall + 1) }} cityId={e.City_ID}>{e.City}</p>
                            <hr />
                        </>)
                    })}
                </div>
                <div className='' style={{ width: "84vw", height: "92vh", overflowY: "scroll", }}>
                    <h1
                        style={{
                            textAlign: "center",
                            marginTop: "3rem",
