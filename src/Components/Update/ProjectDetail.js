...
const ProjectDetail = (props) => {
    ...
    const [apiCall, setapiCall] = useState([0, 0, 0, 0, 0, 0, 0])
    const [isLoading, setisLoading] = useState([false, true, true, true, true, true, true])
    const [isLoading2, setisLoading2] = useState([false, false, false, false, false, false, false])
