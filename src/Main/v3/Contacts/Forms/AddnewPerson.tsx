...
const AddNewPerson = ({show,setShow}: Props) => {
  const styles = {
    text: {
    ...
    <>
      ...
      >
        ...
        <div style={{display: "flex",flexDirection: "column",alignItems: "flex-start",gap:" var(--8-pad, 8px)"}}>
           ...
           <TFChip
                          value={formData.companyType ?? "Client"}
                          // name={rfp.RFP_ID}
          ...
          <select style={{...styles.text,fontWeight:"400px", border:"none",outline:"none",display: "flex",padding: "4px",justifyContent: "center",alignItems:"center",gap: "8px"}} value={formData.contactType} onChange={handleInputChange} name="contactType">
