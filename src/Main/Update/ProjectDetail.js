...
const ProjectDetail = (props) => {
  ...
  const [apiCall, setCall] = useState([0, 0, 0, 0, 0, 0, 0]);
                          ...
                          <td>
                            {isLoading2[1] ? (
                              ...
                              <FontAwesomeIcon
                                ...
                                icon={faFolder}
                                onClick={(e) =>
                                  openDriveLink(e, row.Project_Files)
                                }
                              />
                            )}
                          </td>
                          ...
                          <td>
                            {isLoading2[3] ? (
                              ...
                              <FontAwesomeIcon
                                ...
                                icon={faFolder}
                                onClick={(e) =>
                                  openDriveLink(e, row.Upload_File)
                                }
                              />
                            )}
                          </td>
                          ...
                          <td>
                            {isLoading2[4] ? (
                              ...
                              <FontAwesomeIcon
                                ...
                                icon={faFolder}
                                onClick={(e) =>
                                  openDriveLink(e, row.Attachment)
                                }
                              />
                            )}
                          </td>
  ...
  const openDriveLink = (e, projectFolderId) => {
    e.preventDefault();
    setisLoading2((prevState) => [
      ...prevState.slice(0, tab),
      true,
      ...prevState.slice(tab + 1),
    ]);
    axios
