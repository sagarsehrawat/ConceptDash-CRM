...
import { HOST, GET_TASKS_BY_ID, GET_PROJECT_TASKS_BY_ID, UPDATE_PROJECT_TASK_5, UPDATE_PROJECT_TASK_4 } from '../../Constants/Constants'
    ...
    useEffect(() => {
        ...
        const handleSubmit = (e) => {
            ...
            if(e.target.name==='Review Proposal') {
                axios.post(HOST + UPDATE_PROJECT_TASK_5, {
                    'id':e.target.value,
                ...
                axios.post(HOST + UPDATE_PROJECT_TASK_4, {
                    'id':e.target.value,
                }, {headers:{'auth':'Rose '+ localStorage.getItem('auth') }}).then((res) => {
                  console.log(res);
                  }).catch((err) => {
